    ...
    <div class="card-body p-0">
        ...
        <div class="col-lg">
            ...
            <form class="user" method="post" action="<?= base_url('Auth'); ?>">
                ...
                <input type="email" class="form-control form-control-user" id="email" name="email" aria-describedby="emailHelp" placeholder="Masukan Email Anda" value="<?= set_value('email'); ?>">
